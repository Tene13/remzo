...
<html>
    <head>
        ...
        <title>Site d'aprrentissage de developpement web</title>
    </head>
            ...
            <header>
                <div id="titre_principal">
                    <div id="logo">
                        ...
                        <h1>savoir tout sur le Webmastering</h1>    
                    </div>
                    <h2>Vous êtes la bienvenue</h2>
                </div>
                ...
                <nav>
                    <ul>
                        ...
                        <li><a href="Phpmysql.php">PhpMysql</a></li>
